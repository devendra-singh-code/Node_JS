...
// fs.promises.writeFile(filePath, "This ia the promises file", "utf-8").then(()=> console.log("file created")).catch((err) => console.log(err))
...
// fs.promises.appendFile(filePath, "\n this is a append data", "utf-8").then((data) => console.log("file updatedd")).catch((err) => console.log(err))
...
fs.promises.unlink("deleted.txt").then(() => console.log("file deleted")).catch((err) => console.log(err))
